import { 
  ...
  /**
   * Procesa el retiro de fondos.
   * @param {Object} params - Parámetros necesarios para el retiro.
   * @param {Object} params.db - Instancia de Firestore.
   * @param {Object} params.selectedCard - Tarjeta seleccionada para el retiro.
   * @param {number} params.monto - Monto a retirar.
   * @param {string} params.descripcion - Descripción del retiro.
   * @returns {Promise<void>}
   */
  export const proceedWithWithdrawal = async ({ db, selectedCard, monto, descripcion }) => {
    ...
    if (monto > selectedCard.balance) {
      throw new Error('No tienes suficiente saldo para realizar el retiro.');
    }
